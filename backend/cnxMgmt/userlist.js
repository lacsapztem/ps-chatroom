...
export class UserList{
    ...
    login = (loginData,connexionId,socket)=>{
        loginData.avatar= 'https://gravatar.com/avatar/' + md5(loginData.userId) + '?s=40'
        this.connectUser(loginData,connexionId,socket,'email')
      }
    connectUser = (loginData,connexionId,socket,type)=>{
      let user={
        ...loginData,
        socketId : socket.id,
        id : connexionId,
